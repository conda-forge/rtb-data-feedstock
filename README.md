...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rtb-data-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12183&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rtb-data-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rtb-data` can be installed with:

```
conda install rtb-data
```

It is possible to list all of the versions of `rtb-data` available on your platform with:
